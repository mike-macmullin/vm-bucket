...
Virtual Marine main bucket for [Scoop](https://scoop.sh), the Windows command-line installer.
...
```pwsh
scoop bucket add vm-bucket https://github.com/mike-macmullin/vm-bucket
scoop install vm-bucket/<manifestname>
```
